...
folder_path = "C:\\Users\\maste\\Downloads"
...
if folder_path:
    ...
    if not csv_files:
        ...
        for csv_file in csv_files:
            ...
            try:
                df = pd.read_csv(file_path, on_bad_lines='skip', encoding='utf-8', encoding_errors='replace')
            except Exception as e:
        ...
        # Display a text input for user queries
        user_query = st.text_input("Ask a question about the combined CSV data:")
